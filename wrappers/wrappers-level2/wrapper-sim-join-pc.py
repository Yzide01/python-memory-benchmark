...
def run_benchmark(n, iters):
    cmd = f"perf stat -e instructions,cycles,LLC-load-misses python3 wrapper-sim-join-pc.py --run {n}"
    data = {"Instructions": [], "Cycles": [], "IPC": [], "LLC_misses": [], "lat_ns": []}
    print(f"Lancement Join PC ({n} éléments, {iters} itérations)...")
