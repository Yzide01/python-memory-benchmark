...
def run_benchmark(n, iters):
    cmd = f"perf stat -e instructions,cycles,LLC-load-misses python3 wrapper-polars-join-pc.py --run {n}"
    data = {"Instructions": [], "Cycles": [], "IPC": [], "LLC_misses": [], "lat_ns": []}
    print(f"Lancement Polars Join PC ({n} éléments)...")
    ...
    print_table(data, "Polars Join PC")
